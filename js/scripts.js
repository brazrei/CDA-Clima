...
var sombra1 = "text-shadow: 1px 1px 0px #ccc;"
var sombra2 = "text-shadow: 1px 1px 0px #ccc;"
var sombra3 = "text-shadow: 1px 1px 0px #ccc;"
var iconSize = 18
...
function plotaMarca(lat, lng, loc) {
	...
	desc = desc.replace("color:yellow","color:yellow; background-color: #555; padding: 2px;")
	desc = desc.replace("color:red","color:red; background-color: #aaa; padding: 2px;")
